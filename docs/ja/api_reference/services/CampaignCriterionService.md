...
| environment | url |
|---|---|
| production  | https://ss.yahooapis.jp/services/V5.1/CampaignCriterionService?wsdl|
| sandbox  | https://sandbox.ss.yahooapis.jp/services/V5.1/CampaignCriterionService?wsdl|
#### Namespace
